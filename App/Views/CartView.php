                            ...
                            <div class="flex items-center justify-between py-4 border-b border-gray-700 last:border-0">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <form method="POST" class="inline">
                                        ...
                                        <button type="submit" name="decrement" class="w-8 h-8 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors duration-200 flex items-center justify-center">-</button>
                                    </form>
                                    <form method="POST" class="inline">
                                        <input type="hidden" name="product_id" value="<?= $group['product']->id ?>">
                                        <button type="submit" name="increment" class="w-8 h-8 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors duration-200 flex items-center justify-center">+</button>
                                    </form>
                                    <form method="POST" class="inline">
                                        <input type="hidden" name="product_id" value="<?= $group['product']->id ?>">
