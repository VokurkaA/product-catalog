        ...
        <?php if (empty($groupedProducts)): ?>
            <div class="bg-gray-800 rounded-lg p-8 text-center border border-gray-700">
                ...
                <a href="/product-catalog"
                   class="inline-block bg-blue-600 hover:bg-blue-500 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
                    Continue Shopping
                </a>
            </div>
        <?php else: ?>
            <div class="bg-gray-800 rounded-lg shadow-lg border border-gray-700">
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <form method="POST" class="inline">
                                    ...
                                    <button type="submit" name="decrement"
                                            class="w-8 h-8 bg-gray-700 hover:bg-gray-600 text-white rounded-lg transition-colors duration-200 flex items-center justify-center">
                                        -
                                    </button>
                                </form>
                                <form method="POST" class="inline">
                ...
                <div class="bg-gray-900 p-6 rounded-b-lg">
                    ...
                    <div class="flex justify-end space-x-4">
                        <a href="/product-catalog"
                           class="bg-gray-700 text-white hover:bg-gray-600 font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
                            Continue Shopping
                        </a>
                        <a href="/product-catalog/checkout"
