    ...
    <div class="block md:flex md:justify-between md:items-center mb-8 space-y-4 md:space-y-0 md:space-x-4">
        ...
        <form method="GET" action="">
            ...
            <select name="sort"
                ...
                <option value="default" <?= isset($_GET['sort']) && $_GET['sort'] == 'default' ? 'selected' : '' ?>>Sort
                    by...
                </option>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-8">
            ...
            <?php else: ?>
                <?php foreach ($categories[$_GET['category']]->childrenIds as $c): ?>
                    <a href="?category=<?= $c . $queryString ?>"
                       class="w-full bg-gray-800 rounded-lg p-4 border border-gray-700 hover:shadow-lg transition-shadow">
