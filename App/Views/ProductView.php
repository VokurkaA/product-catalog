            ...
            <div class="flex flex-col md:flex-row gap-12">
                <div class="w-full md:w-1/2">
                    <div class="relative bg-gray-700/50 backdrop-blur rounded-xl aspect-square flex items-center justify-center group transition-all hover:bg-gray-700/70">
                        <?php if ($user): ?>
                            <form method="POST" class="absolute top-4 right-4">
                                <button type="submit" name="like"
                                    ...
                                    <?php else: ?>
                                        <svg class="h-8 hover:fill-red-500 transition-colors duration-300"
                        ...
                        <?php endif; ?>
                        <img class="h-full w-full rounded-xl" src="<?= '../placeholder.webp' ?>"
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <div class="mb-4">
                        ...
                        <a href="/product-catalog?search=<?= urlencode($product->brand) ?>"
                           class="text-gray-200 ml-2 hover:text-blue-400"><?= htmlspecialchars($product->brand) ?></a>
                    </div>
