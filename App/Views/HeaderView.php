            ...
            <nav class="flex items-center justify-between">
                <div class="flex items-center">
                    <a class="absolute left-5" title="profile" href="/product-catalog/profile">
                        <svg class="h-8 w-8 text-white mr-3" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <?php if ($user && ($user->role === 'admin' || $user->role === 'owner')) : ?>
                    <a class="flex items-center space-x-2 text-white hover:text-gray-200 transition duration-300"
                ...
                <?php if ($user) : ?>
                    <a class="relative group" title="cart" href="/product-catalog/cart">
                        <svg class="h-8 w-8 text-white hover:text-gray-200 transition duration-300"
